                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="">
                                            ...
                                            <td><?php echo $row['no_hp_pengguna'];?></td>
                                            <td><?php echo $row['role'];?></td>
                                     
                                            <td>
                                                <a href="data_edit.php?id=<?php echo $row['id_pengguna'];?>" class="btn btn-info btn-sm"><i class="fas fa-edit"></i> Edit</a>

                                                <a href="javascript:;" data-id="<?php  echo $row['id_pengguna'] ?>" data-toggle="modal" data-target="#modal-konfirmasi" class="btn btn-warning btn-sm"><i class="fas fa-trash-alt"></i> Hapus</a>
                                            </td>
                                        </tr>
                                        <?php }?>
                                    </tbody>
