                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        <?php
                                            include '../koneksi.php';
                                            $no=0;
                                            $result = mysqli_query($koneksi, "SELECT * FROM pelanggan ORDER BY nama_pelanggan ASC");
                                        ...
                                        <tr class="">
                                            ...
                                            <td>
                                                <a href="data_edit.php?id=<?php echo $row['id_pelanggan'];?>" class="btn btn-info btn-sm"><i class="fas fa-edit"></i> Edit</a>

                                                <a href="javascript:;" data-id="<?php  echo $row['id_pelanggan'] ?>" data-toggle="modal" data-target="#modal-konfirmasi" class="btn btn-warning btn-sm"><i class="fas fa-trash-alt"></i> Hapus</a>
                                            </td>
                                        </tr>
                                        <?php }?>
                                    </tbody>
